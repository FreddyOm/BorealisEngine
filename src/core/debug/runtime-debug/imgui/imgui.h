...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsBorealis(ImGuiStyle* dst = NULL);    // custom Borealis styling
    ...
    IMGUI_API bool          DynamicTextButton(ImGuiButtonFlags flags = 0, const ImVec2 size_arg = ImVec2(0, 0), const char* label = "", ...) IM_FMTARGS(3);
    IMGUI_API bool          DynamicTextButtonV(ImGuiButtonFlags flags = 0, const ImVec2& size_arg = ImVec2(0, 0), const char* label = "", va_list args = 0) IM_FMTARGS(3);
