...
namespace ImGui
{
    ...
    IMGUI_API bool          DynamicTextButton(ImGuiButtonFlags flags = 0, const ImVec2 size_arg = ImVec2(0, 0), const char* fmt = "", ...) IM_FMTARGS(3);
    IMGUI_API bool          DynamicTextButtonV(ImGuiButtonFlags flags = 0, const ImVec2& size_arg = ImVec2(0, 0), const char* fmt = "", va_list args = 0) IM_FMTLIST(3);
